...
<div style="padding-top: 10px" class="container-fluid pb-5">
<h1 class="ft-prompt">EQAS MUMT 2023 PAYMENT STATUS</h1>
	<button class="btn btn-success mb-3" onClick="document.location='registerExportXls.php';"><i class="far fa-file-excel"></i> Export to Excel</button>
