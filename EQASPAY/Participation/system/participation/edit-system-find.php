...
<div style="padding-top: 130px; padding-left: 20px; padding-right: 20px">
	...
	<h1 class="ft-prompt"><i class="fas fa-file-invoice-dollar"></i> EDIT Systems</h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="home.php">Home</a></li>
	<li class="breadcrumb-item"><a href="participation.php">Participation</a></li>
    <li class="breadcrumb-item active" aria-current="page">Edit System</a></li> 
  </ol>
</nav>
	
  <input type="number" class="form-control-lg" placeholder="ID" name="id" maxlength="8" required autofocus style="width: 300px" >
