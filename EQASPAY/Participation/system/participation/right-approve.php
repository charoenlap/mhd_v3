...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item"><a href="right-find.php">Right Find</a></li>   
  ...
  <tbody>
    <tr>
		...
		$va = null;
		$sql = "SELECT * FROM participantRegister WHERE (id <> '$va') AND ($scheme > '0') AND ($schemep = '$status')  ORDER BY id ASC";
