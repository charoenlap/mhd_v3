...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item"><a href="scheme-find.php">Status Find</a></li>   
    <li class="breadcrumb-item active" aria-current="page"><?php echo strtoupper($scheme); ?> Right Status</li>
  </ol>
</nav>
  ...
  <tbody>
    <tr>
		...
		$va = null;
		$sql = "SELECT * FROM payment_lists WHERE (id <> '$va') AND ($scheme = '$status')   ORDER BY id ASC";
		$result = mysqli_query($link, $sql);
		$rowcount = mysqli_num_rows($result);
		
			 ?>
		
			<h3 class="ft-prompt" style="text-align: left"><i class="fas fa-hospital-user fa-2x">&nbsp; </i><?php echo $st." ". $rowcount; ?> Laboratories </h3>
