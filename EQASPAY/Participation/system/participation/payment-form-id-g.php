...
<form class="form-inline" method="post" action="payment-form-g.php">
...
<nav aria-label="breadcrumb">
  ...
  <input type="number" class="form-control-lg" placeholder="ID" name="id" max="20239999" min="20230000" required autofocus style="width: 300px" >
  
  <button type="submit" class="btn btn-lg btn-primary">Submit <i class="fas fa-angle-double-right"></i></button>
</form>

<form method="post" action="session-unset-g.php" style="padding-top: 20%">
<button type="submit" class="btn btn-lg btn-danger">ออกจากระบบ <i class="fas fa-angle-double-right"></i></button>
</form>
