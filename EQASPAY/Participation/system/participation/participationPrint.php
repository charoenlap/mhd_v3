...
<table width="100%" bgcolor="#0035ad" border="0">
  <tbody>
    <tr>
      ...
      <td width="80%" style="vertical-align: center; text-align: right;"><h2 class="ft-prompt text-white pr-5"><strong>ระบบพิมพ์แบบสถานะการสมัครสมาชิก</strong> 	<br>
...
<form action="participationPrint-find.php" method="post">
	<input type="hidden" name="route" value="OK">
      <input type="number" id="id" style="width: 500px; text-align: center" class="form-control form-control-lg mb-3 mt-3" name="id" maxlength="8" min="20220000"  max="20229999" autofocus required value="<?php echo $_SESSION["pid"]; ?>">
