                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <form action="<?php echo $action ?>" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="language_detail_id" value="<?= $content_detail->detail_id ?>">
                            <div class="card-body">
                                <label class="mt-2">Category title TH</label>
                                <input type="text" name="detail_name" class="form-control" value="<?php echo $content_detail->name; ?>" required>
                                ...
                                <?php if (!empty($content_detail->picture1)) { ?>
                                    <label class="mt-2">Recenly File</label>
                                    <br>
                                    <a href="<?php echo base_url('upload/content/' . $content_detail->picture1); ?>" target="new" class="btn btn-primary">VIEW</a>
