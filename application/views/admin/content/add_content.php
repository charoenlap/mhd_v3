                    ...
                    <div class="card">
                        ...
                        <input type="hidden" name="time_update" value="<?php echo time(); ?>">
                            <div class="card-body">
                                ...
                                <input type="text" name="detail_name" class="form-control" value="<?php echo $lists->name; ?>" required>
                                <label class="mt-2">Category Details TH</label>
                                <textarea name="detail" id="detail_editor" cols="30" class="form-control ckeditor" rows="5"><?php echo $lists->detail; ?></textarea>
                                ...
                                <div class="card-footer text-left pl-0 bg-white">
