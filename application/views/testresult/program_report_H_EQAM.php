                ...
                <div class="container-fluid">
                    ...
                    <form class="user" action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="container-left">
                            ...
                            <div class="col">
                                <h6><label class="font-weight-bold">Trial : </label> 6301</h6>
                            </div>
                                    ...
                                    <table class="table text-center table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="sample[0][5]" type="checkbox" value="1" id="test_0_sec_2_5">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="sample[1][5]" type="checkbox" value="1" id="test_1_sec_2_5">
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
