                ...
                <?php foreach ($infections_sec1 as $key => $infection) : ?>
                    <?php if ($infection->code == 16) : ?>
                        <tr>
                            ...
                            <td><input type="number" step="0" amount_attr="0" class="amount_cal form-control" name="save[sum_sec1][][<?php echo $infection->id; ?>]"></td>
                            <td><input type="number" step="0" amount_attr="1" class="amount_cal form-control" name="save[sum_sec1][][<?php echo $infection->id; ?>]"></td>
                        </tr>
                    <?php endif; ?>
                    <tr>
                        <td><?php echo $infection->code; ?></td>
                        <td><?php echo $infection->name; ?></td>
                        <td><input type="number" step="0" amount_attr="0" class="amount_cal form-control" name="save[sample][][<?php echo $infection->id; ?>]"></td>
                        <td><input type="number" step="0" amount_attr="1" class="amount_cal form-control" name="save[sample][][<?php echo $infection->id; ?>]"></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" name="save[sample][][<?php echo $infection->id; ?>]" type="checkbox" value="1" id="test_0_sec_2_<?php echo $infection->id; ?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" name="save[sample][][<?php echo $infection->id; ?>]" type="checkbox" value="1" id="test_1_sec_2_<?php echo $infection->id; ?>">
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
                ...
                <?php foreach ($infections_sec3 as $infection) : ?>
                    <tr>
                        ...
                        <?php foreach ($specimens as $specimen) : ?>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="save[sample][][<?php echo $infection->id; ?>]" id="radio_0_sec_3_1_6" value="0.5">
                                </div>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="save[sample][][<?php echo $infection->id; ?>]" id="radio_0_sec_3_2_6" value="1">
                                </div>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="save[sample][][<?php echo $infection->id; ?>]" id="radio_0_sec_3_3_6" value="2">
                                </div>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="save[sample][][<?php echo $infection->id; ?>]" id="radio_0_sec_3_4_6" value="3">
                                </div>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="save[sample][][<?php echo $infection->id; ?>]" id="radio_0_sec_3_5_6" value="4">
                                </div>
                                <!-- second check -->
                    ...
                    <?php if ($infection->other == 1) : ?>
                        <tr>
                            ...
                            <?php foreach ($specimens as $specimen) : ?>
                                <td>
                                    <div class="form-check">
                                        <input class="form-control" name="save[sample][][<?php echo $infection->id; ?>]" type="text" id="">
                                    </div>
                                </td>
                            <?php endforeach; ?>
                        </tr>
                    <?php else : ?>
                        <tr>
                            ...
                            <?php foreach ($specimens as $specimen) : ?>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input" name="save[sample][][<?php echo $infection->id; ?>]" type="checkbox" value="1" id="">
                                    </div>
                                </td>
                            <?php endforeach; ?>
                        </tr>
            ...
            <tbody>
                <?php foreach ($infections_sec5 as $infection) : ?>
                    <tr>
                        ...
                        <?php foreach ($specimens as $specimen) : ?>
                            <td>
                                <select class="custom-select" name="save[sample][][<?php echo $infection->id; ?>]">
                ...
                <?php foreach ($infections_sec6 as $infection) : ?>
                    <?php if ($infection->other == 1) : ?>
                        <tr>
                            ...
                            <?php foreach ($specimens as $specimen) : ?>
                                <td>
                                    <input class="form-control" name="save[sample][][<?php echo $infection->id; ?>]" type="text" value="" id="">
                                </td>
                            <?php endforeach; ?>
                        </tr>
                    <?php else : ?>
