...
<div class="container-left col-md-auto">
    ...
    <?php foreach ($infections_sec3 as $key => $infection) : ?>
        <div class="form-check">
            <input class="form-check-input" type="radio" <?php echo isset($save['result']) && $save['result'] == $infection->code ? 'checked' : ''; ?> name="save[result]" id="radio_<?php echo $key; ?>" value="<?php echo $infection->code; ?>">
            <label class="form-check-label" for="radio_<?php echo $key; ?>">
                <?php echo $infection->name; ?>
            </label>
        </div>
    <?php endforeach; ?>
    <input type="text" name="save[result_other]" value="<?php echo isset($save['result_other']) ? $save['result_other'] : ''; ?>" class="form-control" placeholder="Other ระบุ"></input>
</div>
        ...
        <div class="col-sm-12">
            <div class="card text-black font-weight-bold" style="background-color: <?php echo $bg_color[$key_speci]; ?>; padding:10px;">
                ...
                <div class="card-content">
                    ...
                    <input type="text" class="form-control border-white" value="<?php echo isset($save['result_1'][$key_speci]) ? $save['result_1'][$key_speci] : ''; ?>" name="save[result_1][]">
                    <div class="card-content" style="margin-top: 20px;">
                        ...
                        <?php foreach ($infections_sec1 as $infection) : ?>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="save[infection_sec1][<?php echo $key_speci; ?>]" <?php echo isset($save['infection_sec1'][$key_speci]) && $save['infection_sec1'][$key_speci] ==  $infection->code ? 'checked' : ''; ?> id="radio_sec1_<?php echo $specimen->id . $infection->id; ?>" value="<?php echo $infection->code; ?>" />
                                <label class="form-check-label" for="radio_sec1_<?php echo $specimen->id . $infection->id; ?>">
                                    <?php echo $infection->name; ?>
                                </label>
                            </div>
                        <?php endforeach; ?>
                        <textarea name="save[infection_sec1_other][<?php echo $key_speci; ?>]" id="radio_other" class="form-control border-white" placeholder="Other"><?php echo isset($save['infection_sec1_other'][$key_speci]) ? $save['infection_sec1_other'][$key_speci] : ''; ?></textarea>
                        ...
                        <div class="card-content" style="padding-top: 20px;">
                            ...
                            <table class="table text-center table-hover bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php if (!empty($save['tool_sec2'][$key_speci])) { ?>
                                        <?php foreach ($save['tool_sec2'][$key_speci] as $keys => $val) : ?>
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="save[tool_sec2][<?php echo $key_speci; ?>][]">
                                                        <option value="" selected="">Choose</option>
                                                        <?php foreach ($tools_sec2 as $tool2) : ?>
                                                            <option value="<?php echo $tool2->code; ?>" <?php echo isset($save['tool_sec2'][$key_speci][$keys]) && $save['tool_sec2'][$key_speci][$keys] == $tool2->code? 'selected' : ''; ?> ><?php echo $tool2->name; ?></option>
                                                        <?php endforeach; ?>

                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="number" id="input_result" class="form-control" name="save[result_2][<?php echo $key_speci; ?>][]" value="<?php echo isset($save['result_2'][$key_speci][$keys]) ? $save['result_2'][$key_speci][$keys] : ''; ?>">
                                                </td>
                                                <td>
                                                    <select class="form-control" name="save[infection_sec3][<?php echo $key_speci; ?>][]">
                                                        <option value="" selected="">Choose</option>
                                                        <?php foreach ($infections_sec4 as $infec4) : ?>
                                                            <option value="<?php echo $infec4->code; ?>" <?php echo isset($save['infection_sec3'][$key_speci][$keys]) && $save['infection_sec3'][$key_speci][$keys] == $infec4->code ? 'selected' : ''; ?>><?php echo $infec4->name; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </td>
                                                <td>
                                                    <input type="text" id="input_result" class="form-control" name="save[result_3][<?php echo $key_speci; ?>][]" value="<?php echo isset($save['result_3'][$key_speci][$keys]) ? $save['result_3'][$key_speci][$keys] : ''; ?>">
                                                </td>
                                                <td>
                                    ...
                                    <?php } else {  ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" id="input_result" class="form-control" name="save[result_2][<?php echo $key_speci; ?>][]">
                                            </td>
                                            <td>
                                                <select class="form-control" name="save[infection_sec3][<?php echo $key_speci; ?>][]">
                                                    <option value="" selected="">Choose</option>
                                            ...
                                            <td>
                                                <input type="text" id="input_result" class="form-control" name="save[result_3][<?php echo $key_speci; ?>][]">
                                            </td>
                                            <td>
                                                <a class="btn waves-effect waves-light btn-delete-row btn_event">
                                                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card-content">
                                ...
                                <input type="text" class="form-control border-white" name="save[result_4][<?php echo $key_speci; ?>]" value="<?php echo isset($save['result_4'][$key_speci])?$save['result_4'][$key_speci]:''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container align-middle">
    <div class="form-row">
        ...
        <div class="form-group col">
            <div class="custom-file" style="width: 400px;">
                <label class="custom-file-label" for="file_2"><?php echo isset($_FILES['file_2'])?$_FILES['file_2']['name']:'Upload one file'; ?></label>
        ...
        <div class="form-group col">
            <div class="custom-file" style="width: 400px;">
                <label class="custom-file-label" for="file_3"><?php echo isset($_FILES['file_3'])?$_FILES['file_3']['name']:'Upload one file'; ?></label>
