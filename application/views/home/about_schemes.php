...
<div class="col-sm-12 col-md-9 col-lg-10 about-schemes" style="margin-bottom: 140px;">
    <div class="row">
        <div class="col-sm-8">
        ...
        <div class="row px-3 schemes-content">
            <div class="col-md-12">
                ...
                <div class="container bg-light pt-2 pb-2">
                    ...
                    <p class="m-0">2. สาขาจุลทรรศนศาสตร์คลินิก</p>
                    ...
                    <p class="m-0">3. สาขาปรสิตวิทยา (The External Quality Assessment Scheme in Parasitology: EQAP)</p>
                    <p class="m-0">4. สาขาภูมิคุ้มกันวิทยาคลินิก</p>
                    ...
                    <div style="margin-left:.38in;">-การตรวจไวรัสตับอักเสบชนิดบี (The External Quality Assessment Scheme in Clinical Immunology: EQAI – Hepatitis B)</div>
                    <p class="m-0">5. สาขาจุลชีววิทยาคลินิก (The External Quality Assessment Scheme in Bacteriology, EQAB)</p>
