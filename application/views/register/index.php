    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form class="user" action="<?php echo $action;?>" method="POST">
                    ...
                    <div class="col-12">
                        <table class="table table-bordered" id="programs">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th><input type="checkbox" name="program_id[<?php echo $program->id;?>]" value="1" class="program_check form-control form-control-sm" data-id="<?php echo $program->id;?>" data-price="<?php echo $program->price;?>" /></th>
                ...
                <input type="submit" class="btn btn-primary btn-user btn-block" value="สมัครโปรแกรม">
            </form>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('#checkall').click(function() {
        if ($(this).is(':checked')) {
            $('#programs .program_check').prop('checked', true);
        } else {
            $('#programs .program_check').prop('checked', false);
        }
        calculate();
    });
    ...
    function calculate() {
        ...
        var sum = 0;
        $('#programs .program_check:checked').each(function(index, value) {
