                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900">ลืมรหัสผ่าน!</h1>
                                </div>
                                <form class="user" action="<?php echo $action;?>" method="POST">
                                    <div class="row">
                                        <div class="col-12">
                                            <b>
                                                <p>ระบบจะส่งข้อมูลให้ท่านทางอีเมล</p>
                                            </b>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="ลืมรหัสผ่าน">
                                </form>
                                <hr>
                                <div class="text-center">
